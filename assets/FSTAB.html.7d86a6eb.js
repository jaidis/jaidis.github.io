import{_ as e,o as i,c as n,e as s}from"./app.7b59e2c1.js";const d={},a=s(`<h1 id="fstab" tabindex="-1"><a class="header-anchor" href="#fstab" aria-hidden="true">#</a> FSTAB</h1><p>Archivo de ejemplo de FSTAB</p><ul><li>Deshabilitar escrituras innecesarias en SSD</li><li>Deshabilitar/habilitar particion de swap</li><li>Volcar los archivos temporales a la RAM</li><li>Volcar carpetas de cache (google, telegram, ...) a la RAM</li></ul><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code># /etc/fstab: static file system information.
#
